...
function validateLastName(){
			...
			else if (ln[0] != ln[0].toUpperCase()){
				document.getElementById("errorLastName").innerHTML ="The lastname must start with capital letter!";
			}
...
function validateFirstName(){
			...
			if (fn == "") {
				...
				document.getElementById("errorFirstName").innerHTML ="The firstname must start with capital letter!";
			}
